...
- **Always self-attribute when you write code/documents**: `Assisted-By: senior-engineer (claude-sonnet-4 / SHORT_HASH)`
- **Hash Lookup Priority**:
  1. **First choice**: Check `.claude/agent-hashes.json` for your SHORT_HASH (stay in project directory)
  2. **Fallback only**: If mapping file missing, use `git log --oneline -1 .claude/agents/senior-engineer.md | cut -d' ' -f1`
...
Assisted-By: senior-engineer (claude-sonnet-4 / a1b2c3d)
```